...
import AverageClassInteraction from "./DescripitiveData/AverageClassInteraction";
  ...
  return(
    <div>
      <Row>
        ...
        <Col lg="4" md="6" sm="9">
          <AverageClassInteraction courseId={ courseId } classroomId={ classroomId } curriculumId={ curriculumId }/>
        </Col>
        <Col lg="4" md="6" sm="9">
